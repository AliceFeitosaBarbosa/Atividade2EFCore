...
namespace Atividade2EFCore
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                var banco = new Banco() { Nome = "Banco Itau" };
                contexto.Add(banco);
                contexto.SaveChanges();

                if (!contexto.Agencias.Any())
                {
                    var Agencia = new Agencia() { NumeroAgencia = "0121", BancoId = banco.Id };
            ...
            while (true)
            {
                ...
                Console.WriteLine("1- Listar agencias  2- Agencia  3- Conta  0 - Sair");
                ...
                else if (op == 2)
                {
                    ...
                    if(a == null)
                    {
                        Console.WriteLine("Agencia nao encontrada.Tente novamente!");
                        continue;
                    }

                    Console.WriteLine("Agencia " + a.NumeroAgencia);
                    Console.WriteLine("1- Abrir conta  2- Fechar conta  3- Consultar conta  0- Voltar");
                ...
                else if (op == 3)
                {
                    ...
                    Console.WriteLine("1 - Solicitar  0 - Voltar");                  
